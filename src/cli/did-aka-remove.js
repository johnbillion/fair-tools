...
import { removeAlsoKnownAs } from '../did.js';
...
if (values.help) {
	console.log(`Usage: fair-tools did aka remove [options]

Remove a URL from the alsoKnownAs field of a DID.

Required options:
  -d, --did <did>         The DID to update (did:plc:...)
  -u, --url <url>         The URL to remove from alsoKnownAs
...
console.log(`Removed from alsoKnownAs: ${values.url}`);
