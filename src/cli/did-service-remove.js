...
import { removeServiceUrl } from '../did.js';
...
if (values.help) {
	console.log(`Usage: fair-tools did service remove [options]
...
console.log(`Removed service URL: ${values.url}`);
